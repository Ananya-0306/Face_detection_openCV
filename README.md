...
![](https://github.com/Ananya-0306/Face_detection_openCV/blob/main/f8c70ac378.png)
...
## Blogpost
[Face Detection with Python using OpenCV](https://develover.hashnode.dev/face-detection-in-python-using-a-webcam)
...
**2. [Unofficial pre-built OpenCV packages for Python](https://develover.hashnode.dev/face-detection-in-python-using-a-webcam).**
